...
public struct BinaryMemoryReadStructStream : IBinaryReadStream
{
    internal int _pos;
    ...
    [DebuggerStepThrough]
    public BinaryMemoryReadStructStream(ReadOnlyMemorySlice<byte> data, bool isLittleEndian = true)
    {
        _pos = 0;
        _data = data;
    ...
    public BinaryMemoryReadStructStream(byte[] data, bool isLittleEndian = true)
    {
        _pos = 0;
